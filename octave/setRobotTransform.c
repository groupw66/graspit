                 ...
                 int nrhs, const mxArray *prhs[])
{
  ...
  if (nrhs < 1) {
    mexErrMsgTxt("setRobotTransform takes at least one input argument.");
  } 
  if (nrhs > 2) {
	mexErrMsgTxt("setRobotTransform takes at most two input arguments.");
  }
  if (nlhs > 0) {
		mexErrMsgTxt("setRobotTransform takes no output argument.");
	}

//  if (nlhs > 1) {
//    mexErrMsgTxt("setRobotTransform takes at most one output argument.");
//  }
//  if (nlhs == 0 ) nlhs=1;
